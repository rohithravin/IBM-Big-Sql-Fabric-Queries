...
public class QueryLedger1 {
    ...
    public static void main(String args []) throws Exception {
        ...
        QueryLedger1 t = new QueryLedger1();
        t.init(args[0]);
    ...
    private void queryLedger(FabricConnection connection) throws Exception {
        ...
        String[] args1 = {"account17"};
        Collection<ProposalResponse> responses1Query = connection.queryBlockChain("fabcar", "readAccount", args1);
