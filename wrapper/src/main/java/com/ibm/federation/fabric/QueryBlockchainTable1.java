...
public class QueryBlockchainTable1 {
    ...
    public static void main(String args []) throws Exception {
        ...
        QueryBlockchainTable1 t = new QueryBlockchainTable1();
        t.init(args[0]);
    ...
    private void queryBlockchain() throws InvalidArgumentException, ProposalException, UnsupportedEncodingException {
        ...
        for(BlockClient returnedBlock: list) {
            ...
            System.out.printf("%5d%66s%66s%66s\n", blockNumber, Utilities.hashToString(returnedBlock.getPreviousHash()), Utilities.hashToString(returnedBlock.getHash(connection)), Utilities.hashToString(returnedBlock.getDataHash()));
        }
    }
